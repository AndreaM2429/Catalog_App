...
**Catalog App** is a console app that will help you keep a record of different types of things you own: books, music albums, and games. Everything will be based on the UML class diagram presented [here](https://github.com/microverseinc/curriculum-ruby/blob/main/group-capstone/images/catalog_of_my_things.png). The data is stored in JSON files but it also counts with a database tables structure that could be implemented.
...
<summary>Rspec</summary>
  <ul>
    <li>
      <a href="https://www.tutorialspoint.com/rspec/rspec_quick_guide.htm">Guide</a>
    </li>
  </ul>
</details>
...
- [Live Demo Link](https://drive.google.com/file/d/1V_osBNc9fIaGvbKgxCa6Xal_xpVSkjGf/view?usp=sharing)
